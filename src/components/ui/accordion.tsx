...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="h-(--accordion-panel-height) overflow-hidden px-2 text-xs/relaxed transition-[height] duration-250 ease-out data-ending-style:h-0 data-starting-style:h-0 motion-reduce:transition-none"
      {...props}
    >
      <div
        className={cn(
